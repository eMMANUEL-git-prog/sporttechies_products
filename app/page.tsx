  ...
  const products = [
    {
      ...
      description:
        "A comprehensive sports marketplace connecting athletes with premium equipment, apparel, and accessories from top brands worldwide.",
    ...
    },
    {
      ...
      description:
        "Advanced AI-powered mobile application that predicts and prevents athlete injuries through real-time biomechanical analysis and personalized recommendations.",
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <nav className="border-b border-border bg-card/50 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 h-16 flex items-center justify-between">
          <Link
            href="/"
      ...
      <section className="border-b border-border/50 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-foreground/60 mb-8 text-balance max-w-2xl mx-auto">
            Discover innovative solutions designed to transform how athletes
            train, compete, and shop for sports equipment.
          </p>
          <Link
            href="#products"
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="mb-6 flex items-center justify-between">
                      ...
                      <div
                        ...
                        style={{
                          backgroundColor: `${product.colors.primary}15`,
                        }}
                      >
                        <IconComponent
                          className="h-6 w-6"
          ...
          <div className="border-t border-border pt-8 flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center gap-2 mb-4 md:mb-0">
              ...
              <span className="text-sm text-foreground/60">
                © 2024 SportTechies Innovations Limited
              </span>
            </div>
